...
import com.gst.okhttp.presenter.SecurityCodePresenter;
...
public class NewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LogUtils.d("--------- onCreateView -----------", "11");
        View view = inflater.inflate(R.layout.fragment_news, null);
        mTablayout = (TabLayout) view.findViewById(R.id.tab_layout);
        mViewPager = (ViewPager) view.findViewById(R.id.viewpager);
        mViewPager.setOffscreenPageLimit(3);
        setupViewPager(mViewPager);
        mTablayout.addTab(mTablayout.newTab().setText(getResources().getString(R.string.top)));
        ...
        mTablayout.addTab(mTablayout.newTab().setText(R.string.cars));
        mTablayout.addTab(mTablayout.newTab().setText(R.string.jokes));
        mTablayout.setupWithViewPager(mViewPager); //将tabLayout与viewpager连起来

        // TODO 测试
//        mSecurityCodePresenter = new SecurityCodePresenterImpl();
//        mSecurityCodePresenter.getCode("", "");
        return view;
    }

    private void setupViewPager(ViewPager mViewPager) {
        LogUtils.d("--------- setupViewPager -----------", "22");
