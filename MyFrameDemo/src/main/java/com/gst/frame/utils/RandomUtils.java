...
public class RandomUtils {
    ...
    // (0-(n-1))随机排序
    public static Integer[] getRandomList(int n) {
    ...
    public static int[] getRandomListExceptNum(int numValue, int delNum) {
        ...
        return getRandomSortList(list);
    }

    // 乱序的数组
    public static int[] getArrayRandom(int numValue) {
     ...
     * @return 排序结果
     */
    public static int[] getRandomSortList(int[] list) {
        // 数组长度
