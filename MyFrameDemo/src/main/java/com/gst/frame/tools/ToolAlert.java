...
import com.gst.frame.MApplication;
import com.gst.frame.R;
import com.gst.frame.model.NotificationMessage;
import com.gst.frame.view.ProgressDialog;
...
//        notice.flags |= Notification.FLAG_AUTO_CANCEL; //通知点击清除
        ...
        // 必需的通知内容
        builder.setContentTitle(message.getMsgTitle())
...
//        notice.setLatestEventInfo(mContext, message.getMsgTitle(), message.getMsgContent(),pIntent);
        //发送通知
        mNoticeManager.notify(message.getId(), builder.build());
    }
